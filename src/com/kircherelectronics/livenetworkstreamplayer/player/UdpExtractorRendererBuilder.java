 ...
 * {@link Extractor}.
 */
public class UdpExtractorRendererBuilder implements RendererBuilder
{
	private static final String tag = UdpExtractorRendererBuilder.class
			.getSimpleName();
	...
	public UdpExtractorRendererBuilder(Context context, String userAgent, Uri uri)
	{
	...
	public void buildRenderers(Player player)
	{
		...
		TrackRenderer textRenderer = new TextTrackRenderer(sampleSource,
